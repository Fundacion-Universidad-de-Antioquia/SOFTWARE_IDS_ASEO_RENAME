...
from softwareids.views import index,home,guardar_fecha,novedad_view, enviar_a_sharepoint, cargar_formulario_novedad, obtener_fecha_ingreso, calcular_cantidad_horas, calcular_cantidad_dias
